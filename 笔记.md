...
TSubclassOf提供了UClass类型安全性的模板类。其实就是限定一个类型只能分配一个从它派生来的类，这样保证了类型安全。

[具体详解](https://docs.unrealengine.com/en-US/Programming/UnrealArchitecture/TSubclassOf/index.html)
...
加了TSubclassOf的代码，编辑器的属性窗口仅列出UDamageType派生的类作为该属性的选择。